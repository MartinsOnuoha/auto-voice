      ...
      <q-card-section :class="[isMobile? null: 'q-pa-xl', 'row']">
        <div :class="['col col-md-6 col-lg-6 col-sm-12 col-xs-12', isMobile? null : 'q-pa-lg']">
          <div class="login-form">
            ...
            >
              <q-input class="email" v-model="form.email" outlined dense type="text" label="Enter your email" />
              <div>
        ...
        <div class="col col-md-6 col-lg-6 col-sm-12 col-xs-12 desktop-only">
          <img class="side-image" width="300" src="https://img.freepik.com/free-vector/personal-files-concept-illustration_114360-4013.jpg?size=338&ext=jpg&ga=GA1.2.2102900112.1628985600">
        </div>
      </q-card-section>
    </q-card>
  </q-page>
