...
export const UPDATE_SETTINGS = gql`
  mutation UPDATE_SETTINGS($name: String!, $currency: String, $country: String!, $address: String!, $city: String!, $postal: String!, $company_address: String!, $company_city: String!, $company_country: String!, $company_name: String!, $company_postal: String!, $id: Int!) {
    update_settings_by_pk(pk_columns: { id: $id }, _set: { name: $name, currency: $currency, country: $country, address: $address, city: $city, postal: $postal, company_address: $company_address, company_city: $company_city, company_country: $company_country, company_name: $company_name, company_postal: $company_postal }) {
      address
      id
      company_name
      company_country
